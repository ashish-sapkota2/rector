      ...
      <div className="bg-white py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="text-base text-black md:text-xl lg:text-xl w-full mx-auto space-y-6">
            <p className="text-base text-black md:text-lg lg:text-xl w-full mx-auto">
              ...
              on innovation, integrity, and long-term relationships.</p>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 hover:bg-[#0056b3] hover:text-white group"
              >
                <h3 className="text-2xl font-semibold text-black mb-4 transition-all duration-300 group-hover:text-white">
                  {service.title}
                </h3>
                <p className="text-lg text-gray-700 transition-all duration-300 group-hover:text-white">
                  {service.desc}
                </p>
              </div>
            ))}
